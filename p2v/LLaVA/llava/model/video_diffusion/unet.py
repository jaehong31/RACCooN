...
class VideoInpaintingModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        elif in_channels == 8 or in_channels == 9:
            self.conv_in = InflatedConv3d(in_channels, block_out_channels[0], kernel_size=3, padding=(1, 1))
    ...
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None):
        ...
        config["temp_attn"] = True #user_config.get("temp_attn", True)
        config["ref_frame_type_2"] = None # user_config.get("ref_frame_type_2", None)
        config["cross_frame_type"] = None # user_config.get("cross_frame_type", None)
        config["mask_decoder_type"] = None # user_config.get("mask_decoder_type", None)
        config["lan_cross_attn"] = False #user_config.get("lan_cross_attn", False)
